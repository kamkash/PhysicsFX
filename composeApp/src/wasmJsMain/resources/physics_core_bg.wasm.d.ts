...
export const wasm_bindgen__convert__closures_____invoke__hee5f8c1a748eab7e: (a: number, b: number, c: any) => void;
export const wasm_bindgen__closure__destroy__h62b9fa94840cb34a: (a: number, b: number) => void;
